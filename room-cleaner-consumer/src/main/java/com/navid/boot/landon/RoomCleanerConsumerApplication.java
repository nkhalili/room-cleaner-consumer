...
public class RoomCleanerConsumerApplication {
	...
	@Bean
	public Queue queue() {
		// durable queue means never loose messages, we don't want it to be durable so false
	...
	public MessageListenerAdapter listenerAdapter(RoomCleanerProcessor processor){
		// receiveMessage is the name of your method in your processor class
